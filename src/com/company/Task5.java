...
public class Task5 {
    public static void findDurationSeason(int year){
        ...
        long minutesInWinter = ChronoUnit.MINUTES
                .between(findStartSeason(1965, "winter"), findStartSeason(1965, "spring"))
                + ChronoUnit.DAYS
                        .between(findStartSeason(1965, "end year"), findStartSeason(1966, "winter"));
        long minutesInSpring = ChronoUnit.MINUTES
                .between(findStartSeason(1965, "spring"), findStartSeason(1965, "summer"));
        long minutesInSummer = ChronoUnit.MINUTES
                .between(findStartSeason(1965, "summer"), findStartSeason(1965, "autumn"));
        long minutesInAutumn = ChronoUnit.MINUTES
                .between(findStartSeason(1965, "autumn"), findStartSeason(1965, "end year"));
